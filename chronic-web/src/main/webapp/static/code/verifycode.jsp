...
<%!/*
	...
	*/
	//可选字符列表
	char[] chars = "2345678ABCDEFGHJKLMPQRSTUVWXYabcdefhkmnqrstuvwx".toCharArray();
	//可选字体
	String[] fontNames = new String[] { "Courier", "Arial", "Verdana", "Georgia", "Times", "Tahoma" };
	//可选字体
...
<%
	...
	*/
	...
	//将认证码存入SESSION
	session.setAttribute("verifyCode", new String(codes));

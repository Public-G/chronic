...
<form class="layui-form layui-form-pane">
    ...
    <div class="layui-form-item" style="margin-top: 15px;">
        ...
        <div class="layui-input-block">
            <input type="text" name="request_url" value="${param.request_url}" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">菜单名称</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input" autocomplete="off" name="menu_name" value="${param.menu_name}" lay-verify="required">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">菜单图标</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input" autocomplete="off" name="menu_icon" value="${param.menu_icon}" id="menu_icon" onblur="showIcon()"
                   lay-verify="required">
        </div>
    ...
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(menu_submit)', function (data) {
            ...
            if (!submitBtn.hasClass("layui-btn-disabled")) {
                ...
                $.post("http://www.chronic.com/permission/menu_update", data.field, function (data) {

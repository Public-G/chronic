...
<form class="layui-form layui-form-pane">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="capline" autocomplete="off" placeholder="请输入金额" class="layui-input" lay-verify="required|number">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="scale" autocomplete="off" placeholder="请输入比例"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="year" autocomplete="off" id="year" placeholder="请选择年份" class="layui-input"
                   lay-verify="required">
        </div>
    </div>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(policy_submit)',function(data) {
            ...
            if (!submitBtn.hasClass("layui-btn-disabled")) {
                ...
                $.post("http://www.chronic.com/profession/policy_add",data.field,function(data) {

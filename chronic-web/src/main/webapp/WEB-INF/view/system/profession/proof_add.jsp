...
<form class="layui-form layui-form-pane">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="proof_name" autocomplete="off" placeholder="请输入疾病名称" class="layui-input"
                   lay-verify="required">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="start_time" id="start_time" autocomplete="off" placeholder="请选择起始时间" class="layui-input"
                       lay-verify="required">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="end_time" id="end_time" autocomplete="off" placeholder="请选择终止时间" class="layui-input"
                       lay-verify="required">
            </div>
        </div>
    </div>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(proof_submit)',function(data) {
            ...
            if (!submitBtn.hasClass("layui-btn-disabled")) {
                ...
                $.post("http://www.chronic.com/profession/proof_add",data.field,function(data) {

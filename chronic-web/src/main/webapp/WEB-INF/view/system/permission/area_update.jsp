...
<form class="layui-form layui-form-pane">
    ...
    <div class="layui-form-item" style="margin-top: 15px;">
        ...
        <div class="layui-input-inline">
            <input type="text" id="area_code" name="area_code" value="${param.area_code}" autocomplete="off" class="layui-input" lay-verify="required|areaCodeVerify">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input" autocomplete="off" name="area_name" value="${param.area_name}" lay-verify="required">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-form-mid layui-word-aux" id="level-tip">1:县 2:乡镇 3:村 4:组</div>
        </div>
    </div>
    ...
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(area_submit)',function(data) {
            ...
            if (!submitBtn.hasClass("layui-btn-disabled")) {
                ...
                $.post("http://www.chronic.com/permission/area_update?forwardType=update",data.field,function(data) {
                    if (data.code === code_success) {
                        layer.msg(data.msg);
                        setTimeout(function() {

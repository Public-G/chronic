...
<form class="layui-form">
    <div class="layui-form-item" style="margin-top: 15px;">
        ...
        <div class="layui-input-inline">
            <input type="text" name="role_name" id="role_name" lay-verify="required|rolenameVerify"
    ...
    <div class="layui-form-item" style="margin-top: 15px;">
        ...
        <div class="layui-input-inline">
            <input type="text" name="role_label" id="role_label" lay-verify="required|roleLabelVerify"
    ...
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(role_submit)', function (data) {
            ...
            if (!submitBtn.hasClass("layui-btn-disabled")) {
                ...
                $.post("http://www.chronic.com/permission/role_add", data.field, function (data) {
                    if (data.code === code_success) {
                        layer.msg(data.msg);
                        setTimeout(function () {

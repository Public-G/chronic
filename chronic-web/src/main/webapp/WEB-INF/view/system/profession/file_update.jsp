...
<form class="layui-form layui-form-pane">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="username" value="<s:property value="#file.username"/>" autocomplete="off" placeholder="请输入户主姓名" class="layui-input"
                   lay-verify="required">
        </div>
    </div>
...
<%--    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <s:select name="area_code" headerKey="" headerValue="请选择" list="areaList" listKey="area_code"
                          listValue="area_name" lay-verify="required"/>
            </div>
        </div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="group_id" value="<s:property value="#file.group_id"/>" autocomplete="off" placeholder="请输入组编号" class="layui-input"
                       lay-verify="required">
            </div>
        </div>
    </div>--%>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="create_time" id="create_time"  value="<s:date name="#file.create_time" format="yyyy-MM-dd hh:mm:ss" />" placeholder="请选择" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
